<?php 
	...
	$modulo= $_POST['modulo'];
	$campos= "id_restaurant as id,nombre_restaurant as nombre, CONCAT(IFNULL(calle_restaurant,''), ' ',IFNULL(noint_restaurant,''), ' ',IFNULL(noext_restaurant,''), ' ',IFNULL(colonia_restaurant,'')) as direccion, CONCAT(IFNULL(telefono_restaurant,''),'/',IFNULL(telefono2_restaurant,'')) as telefonos, IFNULL(correo_restaurant,'') as correo";

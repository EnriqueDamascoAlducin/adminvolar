...
<div class="row"> 
	<div class="col-sm-6 col-lg-6 col-md-6 col-6 col-xl-6 ">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="<?php if(isset($restaurant)){echo utf8_encode($restaurant[0]->nombre_restaurant);} ?>" >
		</div>
	</div>
			...
			<select class="selectpicker form-control" id="hotel" name="hotel" data-live-search="true">
				...
				<?php
					foreach ($hoteles as $hotel) {
						$opcEstado="";
						if($estado->value == $restaurant[0]->hotel_restaurant){
							$opcEstado="selected";
						}
						echo "<option value='".$hotel->value."' ".$opcTipo.">".utf8_encode($hotel->text)."</option>";
					}
				?>
...
<div class="row" id="divDatos"> 
	<div class="col-sm-4 col-lg-4 col-md-4 col-6 col-xl-4 ">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="calle" name="calle" placeholder="Calle" value="<?php if(isset($restaurant)){echo utf8_encode($restaurant[0]->calle_restaurant);} ?>" >
		</div>
	</div>
	...
	<div class="col-sm-4 col-lg-4 col-md-4 col-6 col-xl-4 ">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="colonia" name="colonia" placeholder="Colonia" value="<?php if(isset($restaurant)){echo utf8_encode($restaurant[0]->colonia_restaurant);} ?>" >
		</div>
	</div>
	<div class="col-sm-4 col-lg-4 col-md-4 col-6 col-xl-4 ">
		<div class="form-group">
			<label for="municipio">Municipio</label>
			<input type="text" class="form-control" id="municipio" name="municipio" placeholder="Municipio" value="<?php if(isset($restaurant)){echo utf8_encode($restaurant[0]->municipio_restaurant);} ?>" >
		</div>
	</div>
	<div class="col-sm-4 col-lg-4 col-md-4 col-6 col-xl-4 ">
		<div class="form-group">

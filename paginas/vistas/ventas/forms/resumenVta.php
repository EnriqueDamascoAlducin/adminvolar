...
<table class="table "  style="max-width: 100%;">
	<thead class="table-dark">
		...
		<tr>
			<th  scope="col"style="font-size: 75%">
				Nombre
			</th>
			<th scope="col" style="font-size: 75%">
				Cantidad
	...
	<tfoot>
		<tr>
			...
			<th style="text-align: right;font-size: 75%">
				<?php  if($totalServicios>0){ echo $totalServicios; } ?>
			</th>
			<th>

			</th>
			<th style="text-align: right;font-size: 80%">
				<?php
					$total = $total / $monedaPrecio;
					echo "$ ".number_format($total, 2, '.', ',') . " " . $monedaNombre;
					  ?>
			</th>
		</tr>
	</tfoot>

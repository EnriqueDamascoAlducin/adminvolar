...
<?php if(in_array("AGREGAR", $permisos)){ ?>
	<div class="alert alert-info"  data-toggle="modal" data-target="#modal" onclick="accion('agregar', <?php echo $usuario->getIdUsu(); ?>)">
...
<script type="text/javascript" src="vistas/souvenirs/js/index.js"></script>
